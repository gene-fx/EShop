...
public class CatalogInitialData : IInitialData
{
    ...
    private static IEnumerable<Product> GetConfiguredProducts() => new List<Product>()
    {
            new Product()
            {
                ...
                Price = 950.00M,
                Category = new List<string> { "Smart Phone", "Seeded" }
            },
            new Product()
            {
            ...
            new Product()
            {
                ...
                Price = 650.00M,
                Category = new List<string> { "White Appliances", "Seeded" }
            },
            new Product()
            {
            ...
            new Product()
            {
                ...
                Price = 240.00M,
                Category = new List<string> { "Home Kitchen", "Seeded" }
            },
            new Product()
            {
                ...
                ImageFile = "product-6.png",
                Price = 240.00M,
                Category = new List<string> { "Camera", "Seeded" }
            }
    };
}