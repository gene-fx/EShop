...
namespace OrderingInfrastructure.Data.Migrations
{
    ...
    [Migration("20241202142546_InitialMigration")]
            ...
            modelBuilder.Entity("OrderingDomain.Models.Order", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("BillingAdress", "OrderingDomain.Models.Order.BillingAdress#Address", b1 =>
                        {
                            b1.IsRequired();
